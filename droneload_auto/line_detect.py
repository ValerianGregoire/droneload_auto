...
class LineDetect(Node):
    def __init__(self,image):
        ...
        ######### SUBSCRIBER to the topic of the camera data
        self.subscription = self.create_subscriber(CameraData, 'camera_data', self.listener_callback)
        self.subscription
        ######### PUBLISHER to the topic of the line data
        # self.create_publisher(Type de data à mettre, 'line_data', self.publisher_callback)
...
def main(args=None):
    ...
    line_detect = LineDetect('image.png')
